...
new_source = [
    ...
    "copy_600_files(\n",
    "    '/content/drive/MyDrive/dataset/unzip/Denoised_audios', # Denoised -> train/noisy\n",
    "    '/content/drive/MyDrive/dataset/unzip/Raw_audios',      # Raw -> train/clean\n",
    "    'data/train/noisy',\n",
    "    'data/train/clean'\n",
    ")\n",
    "\n",
...
for cell in nb['cells']:
    if cell['cell_type'] == 'code':
        ...
        if "def copy_600_files(src_noisy, src_clean, dst_noisy, dst_clean):" in source_str:
            cell['source'] = new_source
            print("Updated cell with tqdm")
            break
